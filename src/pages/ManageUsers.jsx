...
import { generateStrongPassword, validateEmailWithSuggestions } from '../utils/helpers';
...
const ManageUsers = () => {
  ...
  const handleCreate = async (e) => {
    ...
    const emailValidation = validateEmailWithSuggestions(newUser.email);
  ...
  const handleUpdate = async (e) => {
    ...
    // Validate email format with robust validation
    const emailValidation = validateEmailWithSuggestions(editingUser.email);
    if (!emailValidation.isValid) {
      setError(emailValidation.error);
      return;
    }
          ...
          <div className="mb-4">
            ...
            <div className="flex flex-col gap-2">
              <PasswordInput
                ...
                onGenerate={() => setNewUser(prev => ({ ...prev, password: generateStrongPassword() }))}
              />
            </div>
          </div>
          <div className="mb-4">
            ...
            <div className="mb-4">
              ...
              <div className="flex flex-col gap-2">
                <PasswordInput
                  ...
                  showGenerateBtn={true}
                  onGenerate={() => setEditingUser(prev => ({ ...prev, password: generateStrongPassword() }))}
                />
              </div>
            </div>
            <div className="mb-4">
